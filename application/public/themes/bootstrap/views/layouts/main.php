    ...
    <div class="container">
        <nav class="navbar navbar-default" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo Yii::app()->baseUrl; ?>/">Nexmo Demo</a>
            </div>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <?php $this->widget('zii.widgets.CMenu',array(
                    ...
                    'items'=>array(
                        ...
                        array('label'=>'Nexmo Docs', 'url'=>'https://docs.nexmo.com/'),
                    ),
                )); ?>
                ...
                <?php $this->widget('zii.widgets.CMenu',array(
                    ...
                    'items'=>array(
                        array('label'=>'Fork Me', 'url'=>'https://github.com/fillup/nexmo-demo'),
                    ),
                )); ?>
